from scrap.convert_to_json import make_json
from scrap.combine_csv import combine_csv
import logging
    ...
    for book in books:
        try:
            ...
            df_temp = df_temp.append(
                pd.DataFrame({"book_name": [book_name], "book_genre": [book_genre], "book_author": [book_author], "book_points": [book_points],
...
def make_readable_json():
    ...
    combine_csv()
    make_json(r'data/data.csv', r'data/data.json')
